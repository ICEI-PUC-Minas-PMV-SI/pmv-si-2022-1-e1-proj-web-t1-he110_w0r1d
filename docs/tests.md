...
| RTF-019  |Notícias   | Ao clicar na página de notícias a API não carrega as notícias com suas descrições e links que redirecionam para as páginas onde as notícias podem ser lidas.                                                         | Não  |
