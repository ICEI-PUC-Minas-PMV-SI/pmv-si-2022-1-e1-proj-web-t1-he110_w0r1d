...
|--------------------|------------------------------------|----------------------------------------|
|Interessado em ingressar na área de TI | Encontrar informação|Saber por onde começar e como começar para que se possa atingir o objetivo de ingressar na área de TI.|           
